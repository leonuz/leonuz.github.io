...
### This is an UNINTENDED Solution for these two challenges.
...
If you look closely, you'll notice that both challenges have the same address, same port, and most importantly, the same binary!!
...
An excellent engineering professor taught me: **"As engineers, we can't know ALL the answers, but we should know how to look for them."**
