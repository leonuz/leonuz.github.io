...
<p class="intro"><span class="dropcap">T</span>his year, <a href="https://www.jerseyctf.com/">JerseyCTF</a> came back with another solid lineup of challenges. This time I cleared nearly all of the forensics challenges, missing only the last two (<code>Saturn Colony</code> and <code>mars-dominion</code>) for lack of time, and <code>Cold Wake</code> was especially memorable for me because it was the first one I solved for first blood.
...
This challenge had one file to download, a ZIP file that can be downloaded [here](https://github.com/leonuz/CTFs/bolb/main/stuff/01-cold-Wake.zip)
...
This time the hidden artifact is an MP3 file: [Tape3_small.mp3](https://github.com/leonuz/CTFs/blob/main/stuff/Tape3_small.mp3)
